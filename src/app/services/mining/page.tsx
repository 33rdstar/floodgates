...
import { ChevronLeft, ChevronRight, X, Loader, Square, TriangleDashed, VaultIcon } from 'lucide-react';
        ...
        <div className="min-h-screen bg-white text-gray-100">
                ...
                <div className="absolute inset-0 bg-black/50">
                    <div className="max-w-7xl mx-auto px-4 h-full flex flex-col justify-center">
                        ...
                        <p className="text-xl text-gray-200 mt-4">
                            Comprehensive mining solutions with sustainable practices
                        </p>
                        <button 
            ...
            <div className="max-w-7xl mx-auto px-4 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-gray-900 rounded-lg p-8 border border-orange-900">
                        <h2 className="text-2xl font-bold text-orange-500 mb-4">
                        <Loader className="text-orange-500 mr-4" size={24} />
                            Mineral Ore Extraction
                        </h2>
                        <p className="text-gray-300 mb-4">
                            State-of-the-art extraction processes ensuring maximum yield while maintaining environmental responsibility. We specialize in gold, copper, and rare earth minerals extraction.
                        </p>
                        <ul className="list-disc list-inside text-gray-400 space-y-2">
                            <li>Advanced extraction technologies</li>
                    ...
                    <div className="bg-gray-900 rounded-lg p-8 border border-orange-900">
                        <h2 className="text-2xl font-bold text-orange-500 mb-4">
                        <Square className="text-orange-500 mr-4" size={24} />
                            Cathodes Processing
                        </h2>
                        <p className="text-gray-300 mb-4">
                            High-quality cathode processing facilities producing premium grade copper cathodes meeting international standards.
                        </p>
                        <ul className="list-disc list-inside text-gray-400 space-y-2">
                            <li>99.99% pure copper cathodes</li>
                    ...
                    <div className="bg-gray-900 rounded-lg p-8 border border-orange-900">
                        <h2 className="text-2xl font-bold text-orange-500 mb-4">
                        <TriangleDashed className="text-orange-500 mr-4" size={24} />
                            Gold Trading & Refinery
                        </h2>
                        <p className="text-gray-300 mb-4">
                            Professional gold trading and refinery services with secure transactions and competitive pricing.
                        </p>
                        <ul className="list-disc list-inside text-gray-400 space-y-2">
                            <li>Licensed gold trading</li>
                            <li>Modern refinery facilities</li>
                    ...
                    <div className="bg-gray-900 rounded-lg p-8 border border-orange-900">
                        <h2 className="text-2xl font-bold text-orange-500 mb-4">
                        <VaultIcon className="text-orange-500 mr-4" size={24} />
                            Precious Metal Vault Storage
                        </h2>
                        <p className="text-gray-300 mb-4">
                            State-of-the-art vault facilities providing secure storage solutions for precious metals and minerals.
                        </p>
                        <ul className="list-disc list-inside text-gray-400 space-y-2">
                            <li>24/7 security monitoring</li>
                            <li>Climate-controlled environment</li>
                            <li>Insurance coverage</li>
                            <li>Regular auditing and reporting</li>
                        </ul>
                    </div>
                </div>
            </div>
